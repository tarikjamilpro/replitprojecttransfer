...
- **Wan AI Image Generator**: Generate AI images for free in the browser using the Wan 2.6 model via Puter.js (`puter.ai.txt2img`). No API key or signup required. Supports negative prompts, batch size up to 4, aspect ratios (1:1, 16:9, 9:16, 4:3), keyboard shortcut (Ctrl/Cmd+Enter), per-image download/copy/regenerate, and toast notifications.
